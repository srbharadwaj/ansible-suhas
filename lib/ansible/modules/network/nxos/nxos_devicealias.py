...
class showDeviceAliasStatus(object):
    ...
    def execute_show_cmd(self, cmd):
        ...
        # self.module.fail_json(msg=output)
        return output
...
class showDeviceAliasDatabase(object):
    ...
    def update(self):
        ...
        # self.module.fail_json(msg=self.da_dict)
...
def main():
    ...
    if da is not None:
        ...
        for eachdict in da:
            ...
            pwwn = eachdict['pwwn']
            remove = eachdict['remove']
            # module.fail_json(msg=shDADatabaseObj.get_da_list())
            if remove:
        ...
        # module.fail_json(msg=da_add_list)
